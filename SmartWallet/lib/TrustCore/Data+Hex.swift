...
extension Data {
    ...
    /// Returns the hex value representation of the data.
    public var hexValue: String {
        return "0x"+hexString
    }
    
    public var hexValueNoLeadingZero: String {
        let string: String
        ...
        if hexString.count > 1 && hexString.hasPrefix("0") {
            string = String(hexString.dropFirst(1))
        } else {
            string = hexString
        }
           return "0x"+string
